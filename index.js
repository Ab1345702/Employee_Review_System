...
const {ERS_SESSION_SECRET } = process.env;
...
app.listen( process.env.ERS_PORT, (err) => {
  if (err) {
    console.log(`Error in running the server: ${err}`);
  }
  console.log(`Server is running on port: ${process.env.ERS_PORT}`);
});
